#+TITLE: A Python interactive course on Org-babel
#+Date: [2020-12-18 ven.]
...
They can also dig into the present one.
This is a guide for a quick introduction
with a collection of code snippets.

It features some of interactions =org-babel= provides
over code source blocks.
It was written with Emacs 26.3 and Org-mode 9.3.6
